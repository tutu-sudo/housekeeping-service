...
public interface ServiceService {
    ...
    /**
     * 后台-查询服务列表（可按类型/大类/上下架筛选）
     */
    List<Service> listServices(Long serviceTypeId, String mainCategory, Integer availableStatus);
    
    /**
     * 前台-根据大类查询可用服务
     */
    List<Service> getServicesByMainCategory(String mainCategory);
