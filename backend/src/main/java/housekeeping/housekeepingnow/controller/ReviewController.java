...
public class ReviewController {
    ...
    @Operation(summary = "按订单获取三方评价包（顾客视角）", description = "包含：顾客评价、服务人员自评、管理员评价")
    @RequireAuth
    @RequireRole({1})
    @GetMapping("/appointment/{appointmentId}/bundle")
    public Result<AppointmentReviewBundleDTO> getBundleForCustomer(@PathVariable Long appointmentId,
        ...
        if (!appointment.getCustomerId().equals(customerDetail.getCustomerId())) {
